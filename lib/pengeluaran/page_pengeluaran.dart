...
import 'package:budgetq/database/DatabaseHelper.dart';
import 'package:budgetq/decoration/format_rupiah.dart';
import 'package:budgetq/model/model_database.dart';
import 'package:budgetq/pengeluaran/page_input_pengeluaran.dart';
        ...
        child: Column(
          children: [
            Card(
              ...
              color: Color.fromARGB(255, 245, 234, 135),
              child: ListTile(
            ...
            strCheckDatabase == 0
                ? Container(
                    ...
                    child: Text(
                        'Pengeluaran kamu belum ada.\nPengeluarannya dicatat dulu yok!',
                        style: const TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(10)),
                        color: Color.fromARGB(255, 245, 234, 139),
                        child: ListTile(
